...
?>
		...
		<div class="logo-container full-width dark">
			...
			<div class="row ">
				<div class="columns text-center small-8 small-offset-2">
					<h1 class="cis-title white-text">Executive Team</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="panel">
		<div class="row">
			<ul class="small-block-grid-1 medium-block-grid-2 margin-double" data-equalizer>
				<li class="underline-black" data-equalizer-watch>
					...
					<p>Speak to past executives to find out who can provide funding for events.
						<p>
			...
			<div class="row">
				...
				<div class="text-center">
					<p class="small-4 columns">Heidi Ghelfi</p>
