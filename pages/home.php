		...
		<div class="row padding-top">
			<ul class="small-block-grid-1 medium-block-grid-2" data-equalizer>
				...
				<li class="text-center">
					<div class="margin" data-equalizer-watch>
						<a class="th" href="http://www.fallcon.com">
							<img src="img/news/fallcon.jpg" width="150px">
						</a>
					</div>
					<div class="floor">
						<h3>Fallcon is coming! Get your tickets.</h3>
				...
				<li class="text-center" >
					<div class="margin" data-equalizer-watch>
						<a class="th" href="img/news/hitachipuzzle.png">
							<img src="img/news/hitachipuzzle.png" width="200px">
						</a>
					</div>
					<div class="floor">
